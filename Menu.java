public class Menu {
        ...
        System.out.println("Nome do passageiro:" + this.passageiro1.getNome());
            System.out.println("Email do passageiro:" + this.passageiro1.getEmail());
            System.out.println("Celular do passageiro:" + this.passageiro1.getCelular());
            System.out.println("Avaliação do passageiro:" + this.passageiro1.getAvaliacao());
        }
